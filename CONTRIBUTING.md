...
Open a GitHub Issue with the label `spec-feedback`. Describe the section, the concern, and your suggested alternative.
...
- Reference the section number you are changing
- Explain why the change improves the spec
- If changing cryptographic requirements, include references to relevant RFCs or NIST publications
- Keep changes minimal and focused

## Code of conduct

Be precise. Be constructive. The goal is the best possible open standard, not winning arguments.
